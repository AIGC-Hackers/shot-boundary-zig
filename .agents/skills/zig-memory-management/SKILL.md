---
name: zig-memory-management-patterns
description: Comprehensive reference for Zig memory management, distilled from core team guidance, community experts, and battle-tested patterns. Targets Zig 0.15+.
---
