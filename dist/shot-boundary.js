...
const j = "web-v0.0.3", q = "AIGC-Hackers/shot-boundary-zig", K = "shot-boundary-models", V = 720 * 60 * 60 * 1e3, R = "x-shot-boundary-cached-at";
function ce(e = {}) {
  const t = e.tag ?? j, n = e.origin ?? q, a = e.wasmBaseUrl ?? `https://cdn.jsdelivr.net/gh/${n}@${t}/assets/ort-wasm/`, r = e.modelUrl ?? `https://raw.githubusercontent.com/${n}/${t}/assets/models/transnetv2.onnx`, s = e.modelCacheKey ?? `${t}/models/transnetv2.onnx`, o = e.modelCacheTtlMs ?? V;
  return {
    tag: t,
    wasmBaseUrl: a,
    modelUrl: r,
